...
export default function StockEditPage() {
  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        await handleLoadStock(id, "product");
      } catch (err) {
        console.error(err);
      } finally {
        setLoading(false);
  ...
  async function handleSaveStock() {
    ...
    const targetId = isBase ? id : selectedVariationId;
        ...
        <div className="settingsCard">
          ...
          <div className="stockTargetList">
            <button
              ...
              onClick={() => handleLoadStock(id, "product")}
            >
              Principal
            </button>
              ...
              {stockType === "file" && (
                <>
                  <div className="fileUploadZone">
                    ...
                    <input type="file" ref={fileInputRef} className="settingsInput" />
                    {stockContent && <p>Arquivo atual: {stockContent}</p>}
                  </div>
